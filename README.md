...
- Layered break presentation:
  - while focusing, the Break setting value can toggle only the upcoming scheduled break between the default full-screen break and `Desk break`; the choice resets once that scheduled break starts, and no-rest mode still skips it
